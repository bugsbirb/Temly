...
const inputVariants = cva(
  `
  flex w-full border border-input shadow-xs shadow-black/5 transition-[color,box-shadow] text-foreground placeholder:text-muted-foreground/80 
  ...
  `,
  {
    variants: {
      variant: {
        ...
        md: "h-8.5 px-3 text-[0.8125rem] leading-(--text-sm--line-height) rounded-lg",
...
function Autocomplete({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Root>) {
...
function AutocompleteValue({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Value>) {
...
function AutocompleteTrigger({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Trigger>) {
  return (
...
function AutocompleteInput({
  ...
  variant = "md",
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Input> &
...
function AutocompleteIcon({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Icon>) {
  return (
...
function AutocompleteStatus({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Status>) {
  return (
...
function AutocompletePortal({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Portal>) {
  return (
    <BaseUIAutocomplete.Portal data-slot="autocomplete-portal" {...props} />
  );
}
...
function AutocompleteBackdrop({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Backdrop>) {
  return (
    <BaseUIAutocomplete.Backdrop data-slot="autocomplete-backdrop" {...props} />
  );
}
...
function AutocompletePositioner({
  ...
  React.ComponentProps<typeof BaseUIAutocomplete.Positioner>
>) {
  return (
    <AutocompletePortal>
...
function AutocompletePopup({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Popup>) {
  return (
    <BaseUIAutocomplete.Popup
      ...
      className={cn(
        ...
        "rounded-lg border border-border bg-popover p-2 text-popover-foreground shadow-md shadow-black/5",
...
function AutocompleteList({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.List>) {
  return (
...
function AutocompleteCollection({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Collection>) {
  return (
...
function AutocompleteRow({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Row>) {
  return (
...
function AutocompleteItem({
  ...
  return (
    <BaseUIAutocomplete.Item
      ...
      className={cn(
        "text-foreground relative flex cursor-default select-none items-center gap-2 rounded-lg px-2 py-1.5 text-sm outline-hidden transition-colors data-disabled:pointer-events-none data-disabled:opacity-50",
...
function AutocompleteGroup({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Group>) {
...
function AutocompleteEmpty({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Empty>) {
  return (
...
function AutocompleteClear({
  ...
  children,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Clear>) {
  return (
...
function AutocompleteArrow({
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Arrow>) {
...
function AutocompleteSeparator({
  className,
  ...props
}: React.ComponentProps<typeof BaseUIAutocomplete.Separator>) {
  return (
